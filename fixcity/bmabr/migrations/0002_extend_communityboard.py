...
class Migration:
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CommunityBoard.board'
        db.delete_column(u'gis_community_board', 'board')
        
        # Deleting field 'CommunityBoard.boro'
        db.delete_column(u'gis_community_board', 'boro')
        
        # Adding field 'CommunityBoard.name'
        db.add_column(u'gis_community_board', 'name', orm['bmabr.communityboard:name'])
