...
class Migration:
    ...
    def forwards(self, orm):
        # Adding field 'CommunityBoard.borough'
        # default to brooklyn for now the key cannot be null
        # will fix in the next migration
        # 4 is the primary key for brooklyn
        db.add_column(u'gis_community_board', 'borough', models.ForeignKey(Borough, default=4), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CommunityBoard.borough'
        db.delete_column(u'gis_community_board', 'borough_id')
