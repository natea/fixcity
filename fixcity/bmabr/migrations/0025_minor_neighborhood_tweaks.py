...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Neighborhood.city'
        # (to signature: django.db.models.fields.CharField(max_length=50))
        db.alter_column(u'gis_neighborhoods', 'city', orm['bmabr.neighborhood:city'])
        
        # Changing field 'Neighborhood.name'
        # (to signature: django.db.models.fields.CharField(max_length=100))
        db.alter_column(u'gis_neighborhoods', 'name', orm['bmabr.neighborhood:name'])
