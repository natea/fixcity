...
class Migration:
    ...
    def forwards(self, orm):
        db.alter_column(u'gis_community_board', 'borocd',
                        models.IntegerField(null=False))
        # for some reason, south doesn't like altering geometry columns
        # db.alter_column(u'gis_community_board', 'the_geom',
        #                 models.MultiPolygonField(null=False))
        db.execute('ALTER TABLE gis_community_board ALTER COLUMN the_geom '
                   'SET NOT NULL')
