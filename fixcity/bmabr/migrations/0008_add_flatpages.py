...
class Migration:
    ...
    def backwards(self, orm):
        ...
        urls = ('/about/', '/contact/', '/faq/', '/press/', '/tools-and-tips/',
                '/verification-kit/', '/placement-guide/')
        query = reduce(lambda x,y: x|Q(url=y), urls, Q())
        FlatPage.objects.filter(query).delete()
