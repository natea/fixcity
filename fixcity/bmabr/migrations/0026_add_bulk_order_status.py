...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NYCDOTBulkOrder.status'
        db.add_column('bmabr_nycdotbulkorder', 'status', orm['bmabr.nycdotbulkorder:status'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'NYCDOTBulkOrder.status'
        db.delete_column('bmabr_nycdotbulkorder', 'status')
    ...
    models = {
        ...
        'bmabr.nycdotbulkorder': {
            ...
            'status': ('django.db.models.fields.ChartField', [], {'default': "'new'", 'max_length': 32}),
