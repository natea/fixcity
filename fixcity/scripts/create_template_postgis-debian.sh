...
# This script was found on this webpage: http://docs.djangoproject.com/en/dev/ref/contrib/gis/install/
# and downloaded from http://geodjango.org/docs/create_template_postgis-debian.sh
